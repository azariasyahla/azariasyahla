...
A decision-support application that combines demand-pattern classification,
forecasting, inventory position, lead time, safety stock, and incoming supply
to generate transparent replenishment recommendations through an interactive
Streamlit dashboard.
